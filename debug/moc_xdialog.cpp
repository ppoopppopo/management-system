...
QT_MOC_LITERAL(1, 8, 29), // "update_ParentPlassificationUI"
QT_MOC_LITERAL(2, 38, 0), // ""
QT_MOC_LITERAL(3, 39, 6), // "accept"
QT_MOC_LITERAL(4, 46, 6), // "reject"
QT_MOC_LITERAL(5, 53, 27), // "receive_ParentClassRecently"
QT_MOC_LITERAL(6, 81, 19) // "ParentClassRecently"

    },
    "XDialog\0update_ParentPlassificationUI\0"
    "\0accept\0reject\0receive_ParentClassRecently\0"
    "ParentClassRecently"
};
...
void XDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->update_ParentPlassificationUI(); break;
        case 1: _t->accept(); break;
        case 2: _t->reject(); break;
        case 3: _t->receive_ParentClassRecently((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&XDialog::update_ParentPlassificationUI)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void XDialog::update_ParentPlassificationUI()
{
