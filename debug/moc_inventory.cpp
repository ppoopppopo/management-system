...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Inventory_t, stringdata0) + ofs \
...
QT_MOC_LITERAL(2, 32, 0) // ""
    ...
    "Inventory\0on_pushButton_clicked\0"
};
...
QT_INIT_METAOBJECT const QMetaObject Inventory::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_Inventory.data,
    qt_meta_data_Inventory,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *Inventory::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Inventory.stringdata0))
