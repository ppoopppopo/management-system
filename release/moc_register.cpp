...
QT_MOC_LITERAL(1, 9, 10), // "this_close"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 28), // "on_btn_return_login__clicked"
QT_MOC_LITERAL(4, 50, 21) // "on_pushButton_clicked"

    },
    "Register\0this_close\0\0on_btn_return_login__clicked\0"
...
void Register::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->this_close(); break;
        case 1: _t->on_btn_return_login__clicked(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Register::this_close)) {
                *result = 0;
                return;
            }
        }
